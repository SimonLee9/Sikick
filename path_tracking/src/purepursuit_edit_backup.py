...
class PurePursuit:
    def __init__(self, look_ahead):
        ...
        self.SikickUTM_sub = rospy.Subscriber('/utm', PoseStamped, self.posestamped_sikick)
    ...
    def posestamped_sikick(self, msg):
    ...
    '''    
    def SikickGps_callback1(self,msg):
        self.utm_x = msg.pose.position.x
        self.utm_y = msg.pose.position.y

    def get_data(self):
        rospy.Subscriber("/utm", PoseStamped, self.SikickGps_callback1) # callback4
    '''
